CLASS zcl_sone99_itabs_complex_sql DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_sone99_itabs_complex_sql IMPLEMENTATION.
...
**********************************************************************
    ...
    out->write( data = airports_full name = `All airports in London (Internal Table):` ).
